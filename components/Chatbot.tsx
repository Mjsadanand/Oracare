...
export default function Chatbot() {
  ...
  return (
    <>
      <div className={`fixed bottom-6 right-6 z-50 transition-all duration-300 ${isOpen ? 'w-96 h-96' : 'w-auto h-auto'}`}>
        {isOpen ? (
          <div className="bg-card rounded-2xl shadow-2xl border border-custom flex flex-col h-full">
            <div className="bg-gradient-to-r from-blue-600 to-blue-700 text-white p-4 rounded-t-2xl flex items-center justify-between">
              <div className="flex items-center space-x-3">
                ...
                <div>
                  <h3 className="font-semibold text-sm">HOPE Assistant</h3>
